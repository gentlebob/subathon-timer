...
const donationImages = [
    { threshold: 0, url: "https://c.tenor.com/wVffZ201Z9UAAAAC/tenor.gif" },
    { threshold: 100, url: "https://cdn.discordapp.com/attachments/730030449329569806/1312291619973890139/trump.gif?ex=674d47cf&is=674bf64f&hm=d0692caf263274bef2211fabc85bb414acbd1b1b108fb67b509059a19992d471&" },
    { threshold: 150, url: "https://cdn.discordapp.com/attachments/730030449329569806/1312295804928524318/frieren-sousou-no-frieren-ezgif.com-resize.gif?ex=674d4bb5&is=674bfa35&hm=97ade116a1123ff5f0eeded77c11386e35d948c45e441ad40b4fbf79d70bd7ef&" },
    { threshold: 200, url: "https://cdn.7tv.app/emote/01FRRFH9M800085N93FNKSAH9H/4x.webp" },
    { threshold: 250, url: "https://media1.tenor.com/m/XbMA2N11cMAAAAAd/cat-side-eye.gif" },
    { threshold: 300, url: "https://cdn.7tv.app/emote/01GRFW2MX8000EZD3QABKW70JZ/4x.webp" },
    { threshold: 400, url: "https://media1.tenor.com/m/_GF7wBzy0-oAAAAd/smile-precure-kise-yayoi.gif&" },
    { threshold: 500, url: "https://cdn.7tv.app/emote/01J2MTX3Z0000D08M7X51E8CWJ/4x.webp" },
    { threshold: 600, url: "https://cdn.discordapp.com/attachments/730030449329569806/1312295834938773534/streaming-ezgif.com-resize.gif?ex=674d4bbc&is=674bfa3c&hm=7df2c58aedf3bf57bd2e9b3dba65e75ec61a4a674765020801b5fad6efe0b349&" },
    { threshold: 800, url: "https://c.tenor.com/zwU22reEGfAAAAAd/tenor.gif" },
    { threshold: 1000, url: "https://cdn.7tv.app/emote/01GR2ZWC1G00004Y5HVCHEMX8H/4x.webp" },
    { threshold: 1250, url: "https://c.tenor.com/vjLLkjTTPXQAAAAd/tenor.gif" },
    { threshold: 1500, url: "https://c.tenor.com/QU0L7ouTqdwAAAAd/tenor.gif" },
    { threshold: 1750, url: "https://cdn.discordapp.com/attachments/730030449329569806/1312807019517972530/ezgif.com-crop_29.gif?ex=674dd650&is=674c84d0&hm=a3827494d9a18ba056fcb38d3c06eff4272d40b6e61020a9047a9c03b6005b48&" },
    { threshold: 2000, url: "https://cdn.discordapp.com/attachments/1157104039880835102/1312305409268125746/Vegeta_2_online-video-cutter.com.gif?ex=674d54a7&is=674c0327&hm=610caa25ad9564b9a2ed1bc3c26ce51aac1bf3a32ef91b0b63c3844025df878d&" },
    { threshold: 2500, url: "https://c.tenor.com/h2xvRpDeSIEAAAAd/tenor.gif" }, 
    { threshold: 2750, url: "https://c.tenor.com/gKlgTZL1BEMAAAAd/tenor.gif" },
    { threshold: 3000, url: "https://c.tenor.com/2q_UknLBc7wAAAAd/tenor.gif" },
    { threshold: 3250, url: "https://cdn.discordapp.com/attachments/1157104039880835102/1312307899334262835/family_online-video-cutter.com.gif?ex=674d56f8&is=674c0578&hm=116a7e0b56b29194539db4532abeba7eaf9eeaac507cf060f5b94cfa8ac224d9&" },
    { threshold: 3500, url: "https://c.tenor.com/AA28lT39Iw8AAAAd/tenor.gif" },
    { threshold: 3750, url: "https://c.tenor.com/npyHSoI--FgAAAAd/tenor.gif" },
    { threshold: 4000, url: "https://cdn.7tv.app/emote/01J9FCY3N8000D15QN0BDGP9B3/4x.webp" },
    { threshold: 4100, url: "" }, //SING MOI MOI
    { threshold: 4200, url: "" }, // MAKE YOUTUBE VIDS
    { threshold: 4300, url: "" }, //BUILD A PC
    { threshold: 4500, url: "https://c.tenor.com/ENTI0gtz8pAAAAAd/tenor.gif" },
    { threshold: 5000, url: "" }, //DARK SOULS
    { threshold: 6000, url: "https://media1.tenor.com/m/kHrKtvfduh4AAAAd/onewism-kiwiyuno.gif" },
    { threshold: 9999, url: "https://cdn.7tv.app/emote/01HMD5KG0G00070FCM1Q64Q9J8/4x.webp" },
    { threshold: 10000, url: "https://cdn.discordapp.com/attachments/730030449329569806/1312298637300076584/flower-unzip-ezgif.com-resize.gif?ex=674d4e58&is=674bfcd8&hm=f923b9c8628877aca8325cf6d1fb81a9d9b3eab956c6a37141d6263296c57bdd&" },
    { threshold: 15000, url: "https://cdn.7tv.app/emote/01JDRWWX512QAFB02DPNJBV5G8/4x.gif" }
];
...
window.addEventListener('onEventReceived', function (obj) {
    ...
    const event = obj.detail.event;
  	//console.log(donoCount , "count on eventge received")
...
if (data.text.startsWith(timerStartCommand)) {
        ...
        if (parsed.length === 3) {
            ...
            console.log(exists);
            if (!exists) {
                const newMilestone = {value: newGoalValue, name: newGoalName, achieved: false};
...
function createGoal(goal) {
    let listItem = document.createElement('div');
  	listItem.classList.add('middle-goal-item');
...
function updateGoalsClasses() {
    ...
    Array.from(goalItems).forEach(goal => {
        goal.classList.remove('middle-goal-item'); // Remove middle class if present
...
updateMilestonesAchieved(donoCount);
var goalsListElement = document.getElementById('donation-goals-list');
var middleGoalElement = document.querySelector('.middle-goal-item');
